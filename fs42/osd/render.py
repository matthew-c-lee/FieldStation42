...
class Text(object):
    ...
    def render_text_texture(self):
        ...
        self.text_texture, self.tex_size = create_text_texture(
            self.string, self.font_size, self.font, self.color
        )
...
def create_window():
    ...
    window = glfw.create_window(
        mode.size.width, mode.size.height, "FieldStation42 OSD", monitor, None
    )
