...
class QuarterHint:
    ...
    def __init__(self, quarter_name):
        ...
        if QuarterHint.test_pattern(quarter_name):
            ...
            raise ValueError(
                "Quarter name not valid: {quarter_name}- should be one of Q1-Q4 or q1-q4"
            )
...
class RangeHint:
    ...
    def __init__(self, range_string):
        ...
        if RangeHint.test_pattern(range_string):
            ...
            try:
                ...
                # this should be a runtime error
                raise ValueError(
                    "Date range not valid - should be of form: December 1 - December 25"
                )
    ...
    def _scrape_dates(m):
        ...
        start = datetime.strptime(
            f"{m.group(1).capitalize()} {m.group(2):0>2}", "%B %d"
        )
